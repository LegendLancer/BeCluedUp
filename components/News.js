              ...
              <div className="news__content">
                <h3 className="news__content-title">
                  <Link href="/single-news">
                    <a>A place where start new life with peace</a>
                  </Link>
                </h3>
          ...
          <div className="col-lg-6 col-sm-6">
            <div className="recent-item">
              ...
              <div className="news__content">
                <h3 className="news__content-title">
                  <Link href="/single-news">
                    <a>We can make a difference in families lives </a>
                  </Link>
                </h3>
                <ul className="news__content-list">
                  <li className="news__content-active__dot">
          ...
          <div className="col-lg-6 col-sm-6">
            <div className="recent-item">
              ...
              <div className="news__content">
                <h3 className="news__content-title">
                  <Link href="/single-news">
                    <a>Build school for poor childrens</a>
                  </Link>
                </h3>
                <ul className="news__content-list">
                  <li className="news__content-active__dot">
          ...
          <div className="col-lg-6 col-sm-6">
            <div className="recent-item">
              ...
              <div className="news__content">
                <h3 className="news__content-title">
                  <Link href="/single-news">
                    <a>Learn how access to clean water</a>
                  </Link>
                </h3>
                <ul className="news__content-list">
                  <li className="news__content-active__dot">
          ...
          <div className="col-lg-6 col-sm-6">
            <div className="recent-item">
              ...
              <div className="news__content">
                <h3 className="news__content-title">
                  <Link href="/single-news">
                    <a>Do something crazy to raise money</a>
                  </Link>
                </h3>
                <ul className="news__content-list">
                  <li className="news__content-active__dot">
          ...
          <div className="col-lg-6 col-sm-6">
            <div className="recent-item">
              ...
              <div className="news__content">
                <h3 className="news__content-title">
                  <Link href="/single-news">
                    <a>Together to help the world better</a>
                  </Link>
                </h3>
                <ul className="news__content-list">
                  <li className="news__content-active__dot">
